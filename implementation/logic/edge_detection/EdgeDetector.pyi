...
class CannyEdgeDetector:
    ...
    def __init__(self) -> None:
        ...
    def get_canny_img(self, grey_img: typing.Annotated[numpy.typing.ArrayLike, numpy.float64], sigma: typing.SupportsFloat | typing.SupportsIndex = 1.0, hight_threshold: typing.SupportsFloat | typing.SupportsIndex = 0.4, low_threshold: typing.SupportsFloat | typing.SupportsIndex = 0.06) -> numpy.typing.NDArray[numpy.float64]:
        ...
    def get_convolved_image(self) -> numpy.typing.NDArray[numpy.float64]:
        ...
    def get_gradient_magnitued(self) -> numpy.typing.NDArray[numpy.float64]:
        ...
    def get_grey_image(self) -> numpy.typing.NDArray[numpy.float64]:
        ...
