...
class TextBoxDetector:
    ...
    def get_clean_text_rows(self) -> list[numpy.typing.NDArray[numpy.float64]]:
        ...
    def get_deskew_canny_image(self) -> numpy.typing.NDArray[numpy.float64]:
        ...
    def get_indexes_of_rows_extreame_points(self) -> list[int]:
        ...
    def get_row_img_f(self) -> list[float]:
        ...
    def get_rows_extream_points(self) -> list[bool]:
        ...
    def get_smoothed_img_f(self) -> list[float]:
        ...
